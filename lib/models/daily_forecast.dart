...
List<DailyForecast> dailyForecastFromJson(String str) => List<DailyForecast>.from(json.decode(str).map((x) => DailyForecast.fromJson(x)));

String dailyForecastToJson(List<DailyForecast> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class DailyForecast {
    ...
    factory DailyForecast.fromJson(Map<String, dynamic> json) => DailyForecast(
        ...
        realFeelTemperature: ApparentTemperature.fromJson(json["RealFeelTemperature"]),
        realFeelTemperatureShade: ApparentTemperature.fromJson(json["RealFeelTemperatureShade"]),
        ...
        past24HourTemperatureDeparture: ApparentTemperature.fromJson(json["Past24HourTemperatureDeparture"]),
        apparentTemperature: ApparentTemperature.fromJson(json["ApparentTemperature"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "Past24HourTemperatureDeparture": past24HourTemperatureDeparture.toJson(),
