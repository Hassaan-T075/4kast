...
class Details {
    ...
    factory Details.fromJson(Map<String, dynamic> json) => Details(
        ...
        sources: List<SourceElement>.from(json["Sources"].map((x) => SourceElement.fromJson(x))),
...
class SourceElement {
    SourceElement({
        ...
        //required this.partnerSourceUrl,
    });

    String dataType;
    SourceEnum? source;
    int sourceId;
    //String? partnerSourceUrl;

    factory SourceElement.fromJson(Map<String, dynamic> json) => SourceElement(
        dataType: json["DataType"],
        source: sourceEnumValues.map[json["Source"]],
        sourceId: json["SourceId"],
        //partnerSourceUrl: json["PartnerSourceUrl"] == null ? null : json["PartnerSourceUrl"],
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "SourceId": sourceId,
        //"PartnerSourceUrl": partnerSourceUrl == null ? null : partnerSourceUrl,
    };
}
...
class TimeZone {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "NextOffsetChange": nextOffsetChange == null ? null : nextOffsetChange?.toIso8601String(),
    };
}
